        ...
        stage('Compile') {
            ...
            steps {
                dir('target-platform') {
					...
					sh './plugin-builder build ../../${PLUGIN_NAME}_${BRANCH}/${PLUGIN_NAME}'
                    archiveArtifacts artifacts: "target/${PLUGIN_NAME}_${BRANCH} ;singleton:=true-${IDEMPIERE_VERSION}.${BUILD_NUMBER}.jar", fingerprint: true
